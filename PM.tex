...
\section{Project Objectives and Description}
	...
	\subsection{Project Objectives}
		\begin{enumerate}
			...
			\item{Launch marketing campaigns one month before project launch date.}
		\end{enumerate}
	...
	\subsection{Benefit calculations}
		Benefits could be calculated by giving application users a survey and asking them their rent payment experience using our system compared to managing rent payments the traditional way.
...
\section{Project Stages}
	...
	\textbf{After closure}
	For the further project ownership, development and maintaining there will be a smaller team of one developer (team may expand if need be).
...
\section{Project Execution Schedule}
	...
	\begin{enumerate}
		...
		\item{Test cases preparation} - test cases are created for the system 
...
\section{Project Team}
	...
	Team is formed by 1 project manager, 1 test engineer who also performs as business analyst, 1 senior software developer who also acts as software architect, 2 software developers (1 software developer also performs as a scrum master) and 1 user experience specialist.
...
\begin{center}
	$9000 - 3700 = 5300$ \euro
\end{center}
  By our calculations, we will break even in 2 years and 11 months, i.e., by 2024-05-01. After which we will generate a steady monthly profit of $5300$ \euro (assuming no changes to currency inflation, customer size, .etc). See table \ref{table:ROITable} for more detailed information.
